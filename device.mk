...
# Note that streak is not a fully open device. Some of the drivers
...
PRODUCT_COPY_FILES := \
	device/dell/streak/boot/vold.fstab:system/etc/vold.fstab \
	device/dell/streak/boot/egl.cfg:system/lib/egl/egl.cfg

# Init files
PRODUCT_COPY_FILES += \
	device/dell/streak/boot/init.rc:root/init.rc \
	device/dell/streak/boot/init.qcom.rc:root/init.qcom.rc \
	device/dell/streak/boot/ueventd.qct.rc:root/ueventd.qct.rc \
	device/dell/streak/boot/busybox:system/bin/busybox \
	device/dell/streak/boot/wpa_supplicant.conf:system/etc/wifi/wpa_supplicant.conf

# Prebuilt kl keymaps
PRODUCT_COPY_FILES += \
	device/dell/streak/boot/streak_keypad.kl:system/usr/keylayout/streak_keypad.kl \
	device/dell/streak/boot/8k_handset.kl:system/usr/keylayout/8k_handset.kl \
...
PRODUCT_COPY_FILES += \
	device/dell/streak/boot/media_profiles.xml:system/etc/media_profiles.xml
...
#----------------------------------------------------------------------
PRODUCT_COPY_FILES += \
	device/dell/streak/clean_dir.sh:clean_dir.sh

# See comment at the top of this file. This is where the other
# half of the device-specific product definition file takes care
# of the aspects that require proprietary drivers that aren't
# commonly available
$(call inherit-product-if-exists, vendor/dell/streak/device-vendor.mk)

...
$(call add-clean-step, find $(PRODUCT_OUT) -maxdepth 1 -name "*.zip" | xargs rm)

# ************************************************
# NEWER CLEAN STEPS MUST BE AT THE END OF THE LIST
# ************************************************
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/build.prop)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/boot*)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/kernel)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/data)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/recovery*)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/system*)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/userdata.img)
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/streak-ota-eng.mistadman.zip)
...
$(call add-clean-step, rm -rf $(PRODUCT_OUT)/symbols)
